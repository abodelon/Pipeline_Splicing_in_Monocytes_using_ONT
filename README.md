...
## Overview
This repository contains the code used to perform the bioinformatics analysis from the manuscript: Bodelón, A., van Haaren, M.J.H., Sobrevals Alcaraz, P. et al. **Native long-read RNA sequencing of human monocytes reveals activation-induced alternative splicing toward functional isoforms**. Nat Commun (2026). https://doi.org/10.1038/s41467-026-73661-5
...
<img width="6000" height="4200" alt="image" src="https://github.com/user-attachments/assets/ac62e720-a421-4e38-879c-0896463427f0" />
Figure 1. Graphical abstract showing the study design and major outcomes. Created in BioRender. Bodelon de Frutos, A. (2026) https://BioRender.com/k4j4366. 
